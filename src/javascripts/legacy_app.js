...
var App = {
  ...
  bootstrap: function () {
    var app = this;
    console.log(app);
    app.client = this.zafClient;
    app.client.get('currentUser').then(function (user) {
      app.user = user;
    });
    app.client.metadata().then(function(metadata) {
      console.log(metadata);
      // app.settings = metadata.settings;
      app.showSearch();
    });
    console.log('noop');
  },
